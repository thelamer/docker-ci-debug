pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'CI_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-ci-debug'
    CONTAINER_NAME = 'ci-debug'
    DOCKERHUB_IMAGE = 'linuxserver/ci-debug'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/ci-debug'
    PR_DOCKERHUB_IMAGE = 'lspipepr/ci-debug'
    DIST_IMAGE = 'alpine'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-ci-debug/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-ci-debug\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-ci-debug\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Ci-debug\" \
          --label \"org.opencontainers.image.description=ci-debug image by linuxserver.io\" \
